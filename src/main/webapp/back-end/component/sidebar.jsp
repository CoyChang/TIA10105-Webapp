...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.jsp" class="brand-link">
      <img src="${pageContext.request.contextPath}/dist/img/logo.png" alt="BookTalk Logo" height="80" width="80" class="brand-image elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="${pageContext.request.contextPath}/dist/img/userAdmin1.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
